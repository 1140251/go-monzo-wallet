...
func (m *Modal) Layout(gtx layout.Context, widgets []layout.Widget) layout.Dimensions {
	...
	dims := layout.Stack{Alignment: layout.Center}.Layout(mGtx,
		layout.Expanded(func(gtx values.C) values.D {
			...
			fillMax(gtx, m.overlayColor, Radius{})
		...
		layout.Stacked(func(gtx values.C) values.D {
			...
			return inset.Layout(gtx, func(gtx values.C) values.D {
				return LinearLayout{
					...
					layout.Rigid(func(gtx values.C) values.D {
						...
						if m.showScrollBar {
							return m.scroll.Layout(gtx, len(widgetFuncs), func(gtx values.C, i int) values.D {
								gtx.Constraints.Min.X = gtx.Constraints.Max.X
						...
						gtx.Constraints.Min.X = gtx.Constraints.Max.X
						return list.Layout(gtx, len(widgetFuncs), func(gtx values.C, i int) values.D {
							return inset.Layout(gtx, widgetFuncs[i])
						})
					}),
				)
